...
access_token = json.loads(requests.get(
    "https://graph.facebook.com/oauth/access_token?client_id=" + os.environ.get('CLIENT_ID') + "&client_secret=08f0ca27a2a4a5ee11e9a3552ad431e7&grant_type=client_credentials").content)['access_token']
